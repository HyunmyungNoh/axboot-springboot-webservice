...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/_education/education-nhm-grid.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        ...
                        <ax:td label='사용여부' width="200px">
                            ...
                            <select name="useYn" class="form-control js-useYn"> <!--form-control을 사용-->
