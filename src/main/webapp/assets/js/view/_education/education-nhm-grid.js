...
/*         data = {pageNumber: 1};
        var paramObj = $.extends({}, caller.searchView.getData(), data); */
        ...
        axboot.ajax({
            type: 'GET',
            // url: "/api/v1/nhmGrid",
            url: '/api/v1/nhmGrid//queryDsl',
            // url: "/api/v1/nhmGrid//myBatis",
            data: paramObj,
...
fnObj.searchView = axboot.viewExtend(axboot.searchView, {
    initView: function () {
        ...
        this.bizno = $('#bizno');
        this.useYn = $('.js-useYn');
        /* this.useYn = $('[data-ax5select="useYn"]').ax5select({
            columnKeys: {
                optionValue: "value",
                optionText: "text"
            },
    ...
    getData: function () {
        return {
            ...
            // ax5ui를 사용할 경우 해당 개체의 val로 가져오지 못한다. 그러므로 다음과 같이 입력하기로 한다.
            // useYn: ($('[data-ax5select="useYn"]').ax5select.('getValue')[0]||{}).value
        };
    },
});
...
/*             onPageChange: function(pageNumber){
            ...
            columns: [
                ...
                { key: 'email', label: COL('company.email'), width: 180, align: 'center', editor: 'text' },
                {
                    key: 'useYn',
