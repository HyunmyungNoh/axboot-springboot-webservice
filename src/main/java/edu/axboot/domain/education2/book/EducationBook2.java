...
public class EducationBook2 extends BaseJpaModel<Long> {
    ...
    @Builder
    public EducationBook2(String companyNm, String ceo, String bizno, String tel, String zip, String address,
