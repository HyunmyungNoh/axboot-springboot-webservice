...
VALUES (200, 'SYSTEM_MANAGER', '교육용 샘플', '{"ko":"교육용 샘플","en":"Sample for Edu"}',  null, 0, 99, null, sysdate(), 'system', sysdate(), 'system');
...
-- 메뉴 생성
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (201, 'SYSTEM_MANAGER', '실습용 그리드', '{"ko":"실습용 그리드","en":"Grid for Prac"}',  200, 1, 1, 'teach-grid', sysdate(), 'system', sysdate(), 'system');
-- 메뉴 권한
...
-- 메뉴 생성
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENsT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (202, 'SYSTEM_MANAGER', '실습용 그리드 폼', '{"ko":"실습용 그리드 폼","en":"GridForm for Prac}',  200, 1, 2, 'teach-grid-form', sysdate(), 'system', sysdate(), 'system');
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (203, 'SYSTEM_MANAGER', '실습용 그리드 폼(tag 사용안함)', '{"ko":"실습용 그리드 폼(tag 사용안함)","en":"GridForm for Prac(No Tag)"}',  200, 1, 3, 'teach-grid-form-without-tags', sysdate(), 'system', sysdate(), 'system');
-- 메뉴 권한
...
-- 메뉴 생성
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (204, 'SYSTEM_MANAGER', '실습용 그리드 모달', '{"ko":"실습용 그리드 모달","en":"GridModal for Prac"}',  200, 1, 4, 'teach-grid-modal', sysdate(), 'system', sysdate(), 'system');
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (210, 'SYSTEM_MANAGER', '실습용 엑셀', '{"ko":"실습용 엑셀","en":"Excel for Prac"}',  200, 1, 10, 'teach-excel', sysdate(), 'system', sysdate(), 'system');
-- 메뉴 권한
INSERT INTO AUTH_GROUP_MAP_M (GRP_AUTH_CD , MENU_ID, SCH_AH, SAV_AH, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
